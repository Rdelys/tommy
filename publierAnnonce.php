...
<body>
    ...
    <main>
        ...
        <p style="font-size: 12px; color: #636363;">prix (prix de livraison inclus)</p> <br>
        ...
        <div class="btn-group">
            <a href="publierEtat.html" class="btn btn-return"><i class="fas fa-arrow-left"></i> Retour</a>
            <a href="produit.html" class="btn btn-submit">Suivant</a>
        </div>
    </main>
